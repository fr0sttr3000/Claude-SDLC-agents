...
Прочитай:
- $SDLC_PROJECTS_DIR/$ARGUMENTS/stage1-planning/inputs/idea.md
- $SDLC_PROJECTS_DIR/$ARGUMENTS/stage1-planning/outputs/ (проверь наличие PM-*.md)
- $SDLC_PROJECTS_DIR/$ARGUMENTS/Dashboard.md
