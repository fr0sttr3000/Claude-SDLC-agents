...
2. Покажи меню выбора разделов для обновления (1-7), включая Monitoring/Operations
...
4. Запиши соответствующие входные файлы:
   ...
   - BA-input-refresh-YYYY-MM-DD.md (если выбраны требования/беклог/NFR/scope/operations)
